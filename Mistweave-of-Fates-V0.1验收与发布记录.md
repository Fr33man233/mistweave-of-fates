...
本记录中的“验收”仅证明上述规则原型范围可运行，不证明[MVP 发布门](./docs/版本定义与发布门.md)已经通过。
...
[V0.2 首次晋升规则系统验证版设计](./docs/superpowers/specs/2026-08-19-v02-first-ascension-design.md) 承接 V0.1 的案件、状态机、D100 与存档能力，新增角色卡和首次超凡成长规则链。
