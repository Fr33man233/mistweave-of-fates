# AI 原生持续世界 RPG：V0.1 规则与内容数据合同

> 版本：v0.1  
> 状态：可供规则原型实现的设计稿  
> 关联文档：[MVP 系统设计基线](./AI原生持续世界RPG-MVP系统设计-v0.1.md)  
...
工资和价格只是演示值，正式数值必须经过 15 职业的 30 日模拟。
...
V0.1 数据合同通过内部审阅后，下一阶段不是马上生产全部内容，而是制作三个最小样例：
