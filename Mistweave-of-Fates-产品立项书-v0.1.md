...
> 后续系统细化已记录于：[MVP 系统设计基线 v0.1](./Mistweave-of-Fates-MVP系统设计-v0.1.md)。若两份文档在暂定数值、MVP 范围或决策状态上存在差异，以该系统设计基线为准；本文件继续作为产品愿景与立项依据。

> 文档版本：v0.1  
> 文档状态：V0.1 已验收发布；V0.2 本地发布候选已完成
> 更新时间：2026-08-19
> 项目名称：Mistweave of Fates（灰雾织命）  
> V0.1 发布记录：[验收与发布记录](./Mistweave-of-Fates-V0.1验收与发布记录.md)；V0.2：[本地验收与发布候选记录](./Mistweave-of-Fates-V0.2验收与发布记录.md)。
> 当前结论：**V0.2 已完成“普通人至首次晋升”的本地可试玩闭环、自动化验收及桌面/移动宽度浏览器视觉复核；Pages 工作流和线上冒烟尚未完成，因此未标记正式发布。多人持续世界仍不在当前范围内。**
...
- 一个原创的小型恐怖调查区域。
- 一条可在约 30-90 分钟内体验核心循环的主事件链，并允许多种解决方式。
